...
<div class="pcoded-inner-content">
    <div class="main-body">
      <div class="page-wrapper">
        <div class="page-body">
          <div class="row">
            <form class="form-horizontal" role="form" method="POST" action="{{$blog->blog_id}}" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                    <div class="card">
                      ...
                      <span class="text-muted">Edit Blogs here.</span>
                  </div>
              </div>
          </div>
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="form-group {{ $errors->has('blog_title') ? ' has-error' : '' }}">
                  ...
                  <input namtype="text" class="form-control thresold-i thresold-i" required="" name="blog_title" value="{{ $blog->blog_title,old('blog_title') }}" placeholder="Blog Title">
            ...
            <div class="form-group {{ $errors->has('blog_description') ? ' has-error' : '' }}">
              ...
              <textarea name="blog_description" class="form-control summernote-editor" required="" rows="5" placeholder="Enter blog description">{{$blog->blog_description,old('blog_description')}}</textarea>
        ...
        <div class="form-group">
            <label for="file"  class="col-form-label form-control-label">Current blog image</label>
            <div class="col-md-12 p-0">
              <img id="blog_imgs" class="img-fluid" src="{{$base_url}}/storage/app/{{$blog->image}}" required="" style="height:150px;width:150px;">
          </div>
      </div>
      <div class="form-group {{ $errors->has('blog_image') ? ' has-error' : '' }}">
          ...
          <img src="{{$base_url}}/files/assets/images/preview.png" id="blog_image" alt="" width="150" height="150" required="">
    ...
    <div class="form-group {{ $errors->has('url') ? ' has-error' : '' }}">
       ...
       <input namtype="text" class="form-control thresold-i thresold-i" required="" name="url" value="{{$blog->url, old('url') }}" placeholder="URL">
       @if ($errors->has('url'))
       <span class="help-block">
...
<div class="form-group {{ $errors->has('seo_title') ? ' has-error' : '' }}">
    ...
    <input namtype="text" class="form-control thresold-i thresold-i" required="" name="seo_title" value="{{$blog->seo_title, old('seo_title') }}" placeholder="SEO Title">
...
<div class="form-group {{ $errors->has('seo_keywords') ? ' has-error' : '' }}">
    ...
    <input namtype="text" class="form-control thresold-i thresold-i" required="" name="seo_keywords" value="{{ $blog->seo_keywords,old('seo_keywords') }}" placeholder="SEO Keywords">
...
<div class="form-group {{ $errors->has('seo_description') ? ' has-error' : '' }}">
   ...
   <input namtype="text" class="form-control thresold-i thresold-i" required="" name="seo_description" value="{{ $blog->seo_description,old('seo_description') }}" placeholder="SEO Description">
...
<script type="text/javascript">
    ...
    var oldBlogType="{{old('blog_type_id')}}";
        if(oldBlogType!=""){
            $("#blog_type_id option[value="+oldBlogType+"]").prop('selected',true);
        }
