    ...
    <div class="row align-items-center">
      <div class="col-md-12">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a>Refund Money @if($appearance->is_multilanguage==1)
...
<div class="pcoded-inner-content">
  <div class="main-body">
    <div class="page-wrapper">
      <div class="page-body">
        <div class="row">
          <form id="personal-info-form" method="post" action="{{$base_url}}/admin/customer/deductWalletMoney/{{$customer->id}}" enctype='multipart/form-data'>
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header no-border">
                  ...
                  <span class="text-muted">You can deduct money from the customer wallet @if($appearance->is_vshopy==1) vshopy @endif</span>
                </div>
              </div>
            </div>
