        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <img id="product_sample_image" src="/storage/app/{{$product_sample->product_sample_image}}" height="100" >
            </div>
            ...
            <div class="form-group {{ $errors->has('product_sample_image') ? ' has-error' : '' }}">
              ...
              @endif
                ...
                <div class="form-group">
              <img id="order_sample_image" src="/storage/app/{{$product_sample->order_sample_image}}" height="100" >
            </div>
            ...
            <div class="form-group {{ $errors->has('policy_sample_title') ? ' has-error' : '' }}">
                ...
                <div class="form-group">
              <img id="policy_sample_image" src="/storage/app/{{$product_sample->policy_sample_image}}" height="100" >
            </div>
