    ...
    $('#footer-search').DataTable( $.extend({
     ...
     "columns": [{
      ...
      "mRender": function(data, type, row) {
        return '<img class="img-fluid" src="{{$base_url}}/storage/app/'+row.category_image+'" style="height:50px;width:50px;" onerror=this.src="{{$base_url}}/files/assets/images/product.png";>';
      }
    },{ 
