...
<div class="pcoded-inner-content">
  <div class="main-body">
    <div class="page-wrapper">
      <div class="page-body">
        <div class="row">
          <form id="personal-info-form" method="post" action="faq" enctype='multipart/form-data'>
            ...
            <div class="card">
              <div class="card-block">
                ...
                <div class="form-group {{ $errors->has('policy_description') ? ' has-error' : '' }}">
                  <label class="form-control-label">Faq description *  </label>
                  <textarea name="faq_description" class="form-control summernote-editor" rows="" placeholder="Enter faq  description">{{$faq->default_faq_translation->faq_description}} </textarea>
                  @if ($errors->has('description'))
                  <span class="help-block">
                    <strong>{{ $errors->first('faq_description') }}</strong>
                  </span>
                  @endif
                </div>
