...
<div class="page-header">
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header">
                  <h5> Return & Replacement orders</h5>

                  <span class="text-muted">You can view all Replacement orders, Process order, as well as print invoices slip for orders placed from your online business store.</span>
                    ...
                    <table id="footer-search" class="table nowrap">
                      <thead>
                        <tr>
                          ...
                          <th>Order Amount</th>
                          <th>Return & Replacement Reason</th>
                          <th>Action</th>                 
                        </tr>
                      </thead>
                      <tbody>
 ...
 <script type="text/javascript">
   ...
   $('#footer-search').DataTable(  $.extend({    
    ...
    "columns": [{
      ...
      "mRender": function(data, type, row) {
         ...
         if(row.order_return_reason!=null){
           return row.order_return_reason;
         }else{
          return "--";
         }
  ...
  "bSortable": false,
  "ilter":false,
  "mRender": function(data, type, row) { @if($my_permissions->contains('ORDER_DETAILS'))
