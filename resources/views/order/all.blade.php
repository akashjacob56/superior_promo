                ...
                <div class="card-block">
                  <div class="dt-responsive table-responsive">
                    <table id="footer-search" class="table nowrap">
                      <thead>
                        <tr>
                          <td><a href="{{$base_url}}/admin/order/edit/{{$order->id}}">{{$order->id}}</a></td>
                      ...
                      <tbody>
                        ...
                        <tr class="{{$is_important_color}} selection_excla_sign_{{$orderitem->id}}">
                            <td><a href="{{$base_url}}/admin/order/order_item/edit/{{$orderitem->id}}">{{$orderitem->order_id}}S{{$orderitem->id}}</a></td>
