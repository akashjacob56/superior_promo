...
<div class="pcoded-inner-content">
  <div class="main-body">
    <div class="page-wrapper">
      <div class="page-body">
        <div class="row">
          <form id="personal-info-form" method="post" action="{{$order_process->order_process_id}}" enctype='multipart/form-data'>
            ...
            <div class="card">
              <div class="card-block">
                ...
                <div class="form-group {{ $errors->has('order_process_description') ? ' has-error' : '' }}">
                  ...
                  <textarea name="order_process_description" class="form-control summernote-editor" rows="" placeholder="Enter product sample description">{{$order_process->order_process_description}}</textarea>
