...
<div class="card">
	<div class="card-block">
		...
		<h6>Profile</h6>
			...
			<input type="text" name="user" value="{{$customer->id}}" class="form-control thresold-i" maxlength="40" readonly>
			@if ($errors->has('name'))
		...
		<div class="form-group {{ $errors->has('contact_number') ? ' has-error' : '' }} ">
			...
			<input type="text" name="contact_number" value="{{$customer->day_telephone}}" class="form-control thresold-i" maxlength="16" id="mobile-no-cust" placeholder="Enter customer contact number">
			...
			@endif
                                                ...
                                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
			<label class="form-control-label">CIM *</label>
                                                        @if($customer->authorize_net_id!="")
			<input type="text"  name="authorize_net_id" readonly value="{{$customer->authorize_net_id}}" class="form-control thresold-i" maxlength="40" placeholder="CIM">
			@else
                                                        <input type="text"  name="authorize_net_id" readonly value="{{$customer->cim_no}}" class="form-control thresold-i" maxlength="40" placeholder="CIM">
                                                          @endif                                                         
                                                        @if ($errors->has('name'))
			<span class="help-block">
				<strong>{{ $errors->first('name') }}</strong>
...
<div class="card">
	<div class="card-block">
		...
		<div class="form-group {{ $errors->has('password') ? ' has-error' : '' }} ">
			...
			<input type="password" name="password" value="{{$customer->password_show}}" class="form-control thresold-i" maxlength="20" placeholder="Enter password">
		...
		<div class="form-group {{ $errors->has('confirm_password') ? ' has-error' : '' }}">
			...
			<input type="password" name="confirm_password" value="{{$customer->password_show}}"  class="form-control thresold-i" maxlength="20" placeholder="Confirm above password">
				...
				<div class="col-sm-12 edit_billing_address_form hidden">
					...
					<div class="form-group mb-2">
                        ...
                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input united-staten united_state_checkbox_all_state_append" id="billing_united_state_checkbox" checked="">&nbsp;
                            <label class="form-check-label check-checkout mr-2" for="united-staten">United States</label>
                               &nbsp;&nbsp;
                               &nbsp;&nbsp;
                            <input type="checkbox" class="form-check-input canadan canada_checkbox_all_state_append" id="billing_canada_checkbox">&nbsp;
                    ...
                    <div class="form-group mb-2">
                		...
                		<div class="form-group mb-2">
                            ...
                            <input placeholder="City Name"  name="cityn" list="edit-bill-datalist"  id="billing_city" class="form-control txt-lbl">
							    <datalist id="edit-bill-datalist">
							    	@if($data['Allcity']!="[]")
                      ...
                      <div class="form-group mb-2">
                                <label class="form-lbl edit_billing_address_state_label">State<span class="required">*</span></label>
                                <label class="form-lbl hidden edit_billing_address_province_label"> Province <span class="required">*</span></label>
                    ...
                    <div class="form-group mb-2">
                        <label for="acc-text" class="form-lbl edit_billing_address_zipcode_label">Zip Code<span class="required">*</span></label>
                        <label for="acc-text" class="form-lbl hidden edit_billing_address_postalcode_label">Postal Code<span class="required">*</span></label>
					...
					$(document).ready(function(){
						$("#shipping_united_state_checkbox").on("click",function(){
							if($(this).is(":checked")){
								...
								$('.edit_shipping_address_state_label').removeClass('hidden');
								$('.edit_shipping_address_province_label').addClass('hidden');

								$('.edit_shipping_zipcode_label').removeClass('hidden');
								$('.edit_shipping_postalcode_label').addClass('hidden');

							}else{
								$('#shipping_canada_checkbox').prop('checked',true);

								$('.edit_shipping_address_state_label').addClass('hidden');
								$('.edit_shipping_address_province_label').removeClass('hidden');

								$('.edit_shipping_zipcode_label').addClass('hidden');
								$('.edit_shipping_postalcode_label').removeClass('hidden');
							}
						});
			...
			<!-- Edit Shipping Address Start -->
				<div class="col-sm-12 edit_shipping_address_form hidden">
					...
					<div class="form-group mb-2">
                        <label for="acc-text" class="form-lbl">Country<span class="required">*</span></label>
                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input united-staten united_state_checkbox_all_state_append" id="shipping_united_state_checkbox" checked="">&nbsp;
                            <label class="form-check-label check-checkout mr-2" for="united-staten">United States</label>
                               &nbsp;&nbsp;
                               &nbsp;&nbsp;
                            <input type="checkbox" class="form-check-input canadan canada_checkbox_all_state_append" id="shipping_canada_checkbox">&nbsp;
                            <label class="form-check-label check-checkout" for="canadan">Canada</label>
                        </div>
                 	</div>
                    ...
                    <div class="form-group mb-2">
                		...
                		<div class="form-group mb-2">
                            ...
                            <input placeholder="City Name"  name="cityn" list="edit-shipp-datalist"  id="shipping_city" class="form-control txt-lbl">
							<datalist id="edit-shipp-datalist">
								@if($data['Allcity']!="[]")
									@foreach($data['Allcity'] as $city)
										<option value="{{$city->city_name}}">
                      ...
                      <div class="form-group mb-2">
                                <label class="form-lbl edit_shipping_address_state_label">State<span class="required">*</span></label>
                                <label class="form-lbl hidden edit_shipping_address_province_label">Province<span class="required">*</span></label>
                    ...
                    <div class="form-group mb-2">
                        <label for="acc-text" class="form-lbl edit_shipping_zipcode_label">Zip Code<span class="required">*</span></label>
                        <label for="acc-text" class="form-lbl hidden edit_shipping_postalcode_label">Postal Code<span class="required">*</span></label>
...
<form id="addnewbillingaddressform">
   ...
   <div class="form-group mb-2">
        <label for="acc-text" class="form-lbl">Country<span class="required">*</span></label>
         ...
         <div class="form-group form-check">
            ...
            <input type="checkbox" class="form-check-input united-state-bill united_state_checkbox_all_state_append" id="add_billing_united_state_checkbox" checked="">&nbsp;&nbsp;
            <label class="form-check-label check-checkout mr-5" for="united-state-bill">United States</label>
       		
            <input type="checkbox" class="form-check-input canada-bill canada_checkbox_all_state_append" id="add_billing_canada_checkbox">&nbsp;&nbsp;
   ...
   <div class="row">     
    ...
    <!-- <div class="select-custom"> -->
        ...
        <input placeholder="City Name"  name="city-bill" list="add-bill-datalist"  id="add_billing_city" class="form-control txt-lbl">
	    <datalist id="add-bill-datalist">
	    	@if($data['Allcity']!="[]")
		    	@foreach($data['Allcity'] as $city)
			      <option value="{{$city->city_name}}">
    ...
    <!-- </div> -->
      ...
      <div class="col">
       <div class="select-custom">
        <label class="form-lbl add_billing_address_state_label">State<span class="required">*</span></label>
        <label class="form-lbl hidden add_billing_address_province_label">Province<span class="required">*</span></label>
    ...
    <div class="col">
    <div class="form-group mb-2">
        <label for="acc-text" class="form-lbl add_billing_address_zip_code_label">Zip Code<span class="required">*</span></label>
        <label for="acc-text" class="form-lbl hidden add_billing_address_postal_code_label">Postal Code<span class="required">*</span></label>
...
<form id="addnewaddressform">
   	...
   	<div class="form-group mb-2">
        <label for="acc-text" class="form-lbl">Country<span class="required">*</span></label>
         <div class="form-group form-check">
            <input type="checkbox" class="form-check-input united-staten united_state_checkbox_all_state_append" id="add_shipping_united_state_checkbox" checked="">&nbsp;
            <label class="form-check-label check-checkout mr-2" for="united-staten">United States</label>
       &nbsp;&nbsp;
       &nbsp;&nbsp;
            <input type="checkbox" class="form-check-input canadan canada_checkbox_all_state_append" id="add_shipping_canada_checkbox">&nbsp;
            <label class="form-check-label check-checkout" for="canadan">Canada</label>
          </div>
    </div>
    ...
    <div class="select-custom">
        ...
        <input placeholder="City Name"  name="cityn" list="add-shipp-datalist"  id="add_shipping_city" class="form-control txt-lbl">
		<datalist id="add-shipp-datalist">
			@if($data['Allcity']!="[]")
				@foreach($data['Allcity'] as $city)
					<option value="{{$city->city_name}}">
       ...
       <div class="select-custom">
        <label class="form-lbl add_shipping_address_state_label">State<span class="required">*</span></label>
        <label class="form-lbl hidden add_shipping_address_province_label">Province<span class="required">*</span></label>
    ...
    <div class="form-group mb-2">
        <label for="acc-text" class="form-lbl add_shipping_address_zip_code_label">Zip Code<span class="required">*</span></label>
        <label for="acc-text" class="form-lbl hidden add_shipping_address_postal_code_label">Postal Code<span class="required">*</span></label>
...
const inputElement = document.getElementById('mobile-no-cust');
...
console.log(address);
$('#shipping_city').val(address.city.default_city_translation.city_name);
// $('#shipping_city option[value='+address.city_id+']').prop('selected',true);
$('#shipping_state option[value='+address.state_id+']').prop('selected',true);
...
$('#billing_city').val(address.city.default_city_translation.city_name);
...
$('.edit_billing_address_state_label').removeClass('hidden');
$('.edit_billing_address_province_label').addClass('hidden');

$('.edit_billing_address_zipcode_label').removeClass('hidden');
$('.edit_billing_address_postalcode_label').addClass('hidden');

}else if(address.country_id==35){
$('#billing_united_state_checkbox').prop('checked',false);
$('#billing_canada_checkbox').prop('checked',true);

$('.edit_billing_address_state_label').addClass('hidden');
$('.edit_billing_address_province_label').removeClass('hidden');

$('.edit_billing_address_zipcode_label').addClass('hidden');
$('.edit_billing_address_postalcode_label').removeClass('hidden');
}
     	...
     	$(document).ready(function(){
     		$('#add_billing_united_state_checkbox').on('click',function(){
     			if($(this).is(":checked")){
     				...
     				$('.add_billing_address_state_label').removeClass('hidden');
					$('.add_billing_address_province_label').addClass('hidden');

					$('.add_billing_address_zip_code_label').removeClass('hidden');
					$('.add_billing_address_postal_code_label').addClass('hidden');


     			}else{
     				$('#add_billing_canada_checkbox').prop('checked',true); 

     				$('.add_billing_address_state_label').addClass('hidden');
					$('.add_billing_address_province_label').removeClass('hidden');

					$('.add_billing_address_zip_code_label').addClass('hidden');
					$('.add_billing_address_postal_code_label').removeClass('hidden');             		
     			}
    	...
    	$(document).ready(function(){
    		$('#add_shipping_united_state_checkbox').on('click',function(){
    			if($(this).is(':checked')){
    				...
    				$('.add_shipping_address_state_label').removeClass('hidden');
					$('.add_shipping_address_province_label').addClass('hidden');

					$('.add_shipping_address_zip_code_label').removeClass('hidden');
					$('.add_shipping_address_postal_code_label').addClass('hidden');
    			}else{
    				$('#add_shipping_canada_checkbox').prop("checked",true);

    				$('.add_shipping_address_state_label').addClass('hidden');
					$('.add_shipping_address_province_label').removeClass('hidden');

					$('.add_shipping_address_zip_code_label').addClass('hidden');
					$('.add_shipping_address_postal_code_label').removeClass('hidden');
    			}
    		});
...
$('.united_state_checkbox_all_state_append').on('click',function(){
				...
				if($(this).is(':checked')){
    				...
    				$.ajax({
					            ...
					            success: function (result) {    
					               ...
					               if($('#add_billing_united_state_checkbox').is(":checked")){
					               		// alert('add bill');
					               		document.getElementById("add_billing_state").options.length=0;
					               }

					               if($('#billing_united_state_checkbox').is(":checked")){
					               		// alert('edit bill');
					               		document.getElementById("billing_state").options.length=0;
					               }

					               if($('#add_shipping_united_state_checkbox').is(":checked")){
					               		// alert('add shipp');
					               		document.getElementById("add_shipping_state").options.length=0;
					               }

					               if($('#shipping_united_state_checkbox').is(':checked')){
					               		// alert('edit shipp');
					               		document.getElementById("shipping_state").options.length=0;
					               }
					               ...
					               $.each(state,function(index,item){
					                ...
					                if($('#add_billing_united_state_checkbox').is(":checked")){
					                	$("#add_billing_state").append(o);
					            	}

					            	if($('#billing_united_state_checkbox').is(":checked")){
					               		$("#billing_state").append(o);
					               }

					               if($('#add_shipping_united_state_checkbox').is(":checked")){
					               		$("#add_shipping_state").append(o);
					               }

					               if($('#shipping_united_state_checkbox').is(':checked')){
					               		$("#shipping_state").append(o);
					               }
...
$('.canada_checkbox_all_state_append').on('click',function(){
...
var country_id = 35;
    				...
    				$.ajax({
					            ...
					            success: function (result) {    
					               var state=result['states'];
					               if($('#add_billing_canada_checkbox').is(':checked')){
					               		document.getElementById("add_billing_state").options.length=0;
					               }

					               if($('#billing_canada_checkbox').is(':checked')){
					               		document.getElementById("billing_state").options.length=0;
					               }

					              
					               	if($('#add_shipping_canada_checkbox').is(':checked')){
					               		document.getElementById("add_shipping_state").options.length=0;
					               }

					               if($('#shipping_canada_checkbox').is(':checked')){
					               		document.getElementById("shipping_state").options.length=0;
					               }
