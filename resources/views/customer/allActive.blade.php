                        ...
                        <div class="col-4 text-right"><label class="">Activity</label></div>
                            <div class="col-8">
                                <select class="select-width" name="activity" id="search_activity" disabled="">
                                  ...
                                  <option selected="" value="1">Active Only</option>
...
<script type="text/javascript">
    ...
    $('#footer-search').DataTable( $.extend( {     
      "ajax": {
        url: "all-ActiveData?id="+id+"&contact_number="+contact_number+"&email="+email+"&billing_phone="+billing_phone+"&company_name="+company_name+"&shipping_zip_code="+shipping_zip_code+"&user_name="+user_name+"&from_date="+from_date+"&to_date="+to_date+"&frequency="+frequency+"&activity="+activity,
        type: "GET",
...

      {
        ...
        "ilter":false,
        "mRender": function(data, type, row) {
          return '<a class="color-b" href="mailto:business_email">'+row.email+'</a>';  
        }
      },
