										...
										<div class="media-body row">
											<div class="col-lg-12">
												<div class="user-title">
													<h2><!-- @if($vendor->name!=""){{$vendor->name}}@else User @endif --></h2>
...
<!-- 		<div class="col-md-12 p-0">
			<div class="col-sm-12">
				<div class="tab-header card no-border"> 	
					<ul class="nav nav-tabs md-tabs tab-timeline" role="tablist" id="mytab">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#user_info" role="tab">@if($vendor->name!=""){{$vendor->name}}@else User @endif Details</a>
							<div class="slide"></div>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#order" role="tab">@if($vendor->name!=""){{$vendor->name}}@else User @endif's Order</a>
							<div class="slide"></div>
						</li>
					
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#review" role="tab">@if($vendor->name!=""){{$vendor->name}}@else User @endif</a>
							<div class="slide"></div>
						</li>
					</ul>
				</div>
			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="user_info" role="tabpanel">
					<form id="personal-info-form" method="post" action="{{$vendor->id}}" enctype='multipart/form-data'>
						<input type="hidden" name="_token" value="{{csrf_token()}}">
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header no-border">
									<h5><a>{{$vendor->name}}</a></h5>
									...
									<span class="text-muted">You can modify information for vendor according to required types and representations to a given part of your online business .</span>
								</div>
							</div>
						</div>
						<div class="col-md-12 p-0">
							<div class="col-md-7">
			                    ...
			                    <input type="number" name="sage_id" value="{{$vendor->sage_id}}" class="form-control thresold-i" maxlength="40" placeholder="Enter Vendor  sage_id" >
                     ...
                     <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="name" value="{{$vendor->name}}" class="form-control thresold-i" maxlength="40" placeholder="Enter Vendor name" >
                      @if ($errors->has('name'))
                      <span class="help-block">
                    ...
                    <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }} ">
                      ...
                      <input type="email" name="email" value="{{$vendor->email}}"  class="form-control thresold-i" maxlength="40" placeholder="Enter Vendor email">
                      @if ($errors->has('email'))
                      <span class="help-block">
                    ...
                    <div class="form-group {{ $errors->has('contact_number') ? ' has-error' : '' }} ">
                      ...
                      <input type="text" name="contact_number" value="{{$vendor->contact_number}}" class="form-control thresold-i" maxlength="15" placeholder="Enter Vendor contact number">
