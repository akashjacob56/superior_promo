...
<div class="pcoded-inner-content">
    <div class="main-body">
        <div class="page-wrapper">
            <div class="page-body">
                <div class="row">
                    <form id="personal-info-form" method="post" action="{{$discount->discount_id}}" enctype='multipart/form-data'>
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header no-border">
                                    <h5> Edit promocodes</h5>
                                    <span class="upper-buttons">

                                        <button type="submit" class="btn btn-primary waves-effect waves-light pull-right save_button">Save</button>
                                        <a href="all"><button type="button" class="m-r-5 btn btn-default waves-effect waves-light add pull-right">   Cancel
                                        </button></a>  
                                    </span>
                                    <span class="text-muted">You can Edit discounts  by discount volume, coupons and special offer to attract customer to you online business.</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-7 discounts">
                                <div class="card">
                                    <div class="form-group {{ $errors->has('discount_code') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" name="title" value="{{$discount->title}}" class="form-control thresold-i" maxlength="40" placeholder="Enter discount Title">
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                                        ...
                                        <textarea type="text" name="description" value="{{old('description')}}" class="form-control thresold-i" maxlength="40" placeholder="Enter discount description">{{$discount->description}}</textarea>
                                ...
                                <div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                                    <label class="form-control-label" for="usr">Replace above image</label>
                                    <input type="file" class="form-control" name="image" value="{{old('image')}}" accept="image/*" onchange="document.getElementById('coupon_imgs').src= window.URL.createObjectURL(this.files[0])" name="image" class="form-control" accept="image/x-png,image/gif,image/jpeg" >
                                    @if ($errors->has('image'))
                                    <span class="help-block">
                              ...
                              <div class="card-block">
                                <div class="form-group {{ $errors->has('discount_code') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="discount_code" value="{{$discount->discount_code}}" class="form-control thresold-i" maxlength="40" placeholder="Enter discount code">
                        ...
                        <div class="card">
                                ...
                                <div class="form-group row {{ $errors->has('discount_type_id') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group {{ $errors->has('discount_value') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" id="discount_value" name="discount_value" value="{{$discount->discount_value}}"  class="form-control thresold-i" maxlength="30" onkeypress="return event.charCode >= 48 && event.charCode <= 57 ">
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <h6>Applies to *</h6>
                                    <div class="form-group {{ $errors->has('discount_value') ? ' has-error' : '' }}"">
                                        <div class="form-radio" id="applies_to">
                                            @php
                                            $checked="checked";
                                            @endphp
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input  type="radio" class="{{$checked}} applies_to" value="{{$applies_to->applies_to_id}}" name="applies_to_id">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <input type="text" name="minimum_purchase_amount" value="{{$discount->minimum_purchase_amount}}" placeholder="Minimum purchase amount"  class="pull-left minimum_purchase_amount form-control thresold-i" onkeypress="return event.charCode >= 48 && event.charCode <= 57 ">  
                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group {{ $errors->has('customer_eligibility_id') ? ' has-error' : '' }}">
                                        <div class="form-radio" id="customer_eligibility_id">
                                         @php
                                         $checked="checked";
                                         @endphp
                                    ...
                                    <table id="customer_eligibility_table" class="table">
                                        @if(count($discount_customer_apply)!="")
                                        @foreach($discount_customer_apply as $customer)
                            ...
                            <div class="card">
                                <div class="card-block">
                                  ...
                                  <div class="row m-t-25 text-left">
                                    ...
                                    <input type="number" id="number_of_time_use_number" name="number_of_time_use_number" value="{{$discount->limit_number_of_times}}" placeholder="" min="0"  class="pull-left  form-control thresold-i m-2" onkeypress="return event.charCode >= 48 && event.charCode <= 57 ">
                                    <div class="col-md-12">
                                        <div class="checkbox-fade fade-in-primary">
                                            <label>
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group row {{ $errors->has('start_date') ? ' has-error' : '' }}">
                                    <div class="col-md-6 Zebra_DatePicker_Icon_Wrapper">
                                        ...
                                        <input type="text" id="datepicker-from"  name="start_date" value="{{$discount->start_date}}" placeholder="Date from" class="form-control thresold-i" maxlength="30">
                                    ...
                                    <div class="col-md-6 form-group {{ $errors->has('start_time') ? ' has-error' : '' }}">
                                        ...
                                        <input type="time" id="start_time" name="start_time" value="{{$discount->start_time}}"  class="form-control thresold-i" maxlength="30">
                                ...
                                <div class="form-group row Zebra_DatePicker_Icon_Wrapper {{ $errors->has('end_date') ? ' has-error' : '' }}">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="datepicker-to" name="end_date" value="{{$discount->end_date}}" placeholder="End date"  class="form-control thresold-i" maxlength="30">
                                    ...
                                    <div class="col-md-6 form-group {{ $errors->has('end_time') ? ' has-error' : '' }}" >
                                        ...
                                        <input type="time" id="end_time" name="end_time" value="{{$discount->end_time}}"  class="form-control thresold-i" maxlength="30">
...
$("input[name=is_hide][value={{$discount->is_hide}}]").prop('checked', true);
...
$("#discount_type_id option[value={{$discount->discount_type_id}}]").prop('selected',true).change();


$("input[name=applies_to_id][value={{$discount->applies_to_id}}]").prop('checked', true);
$("input[name=customer_eligibility_id][value={{$discount->customer_eligibility_id}}]").prop('checked', true).change();

@if($discount->is_limit_number_of_times==1)
$("input[name=is_number_of_time_use][value=1]").prop('checked', true);
$("#number_of_time_use_number").show();
@endif

@if($discount->only_one_use_per_customer==1)
$("input[name=one_use_per_customer][value=1]").prop('checked', true);
...
$('.customer_eligibility').change(function(){
   ...
   if(customer_eligibility==2){
    ...
    $("#customer_eligibility_table").show();

}
else{
    $(".customer_search").hide();
    $("#customer_eligibility_table").hide();
}
});

@if($discount->customer_eligibility_id==2)
$('.customer_eligibility').change();
$(".customer_search").show();
...
$("#applies_to_data").on("click",".applies_to_add_button",function(){
    ...
    $("#applies_to_table").append('<tr><td>ID</td><td><div class="d-inline-block align-middle"><img src="'+img+'" class="img-radius img-40 align-top m-r-15"></td><td>'+name+'</td><td><button type="button" class="delete_applies_to_item btn btn-danger"><i class="fa fa-trash-o"></i></button></td></tr>');
});
...
$("#applies_to_data2").on("click",".applies_to_add_button2",function(){
    ...
    $("#applies_to_table").append('<tr><td>ID</td><td><div class="d-inline-block align-middle"><img src="'+img+'" class="img-radius img-40 align-top m-r-15"></td><td>'+name+'</td><td><button type="button" class="m-b-10 delete_applies_to_item btn btn-danger"><i class="fa fa-trash-o"></i></button></td></tr>' );
});

search_customers=['{{$customer_ids}}'];
/*search_customers=JSON.parse(search_customers);*/
...
$("#customer_eligibility_data").on("click",".customer_eligibility_add_button",function(){
    ...
    if (stats == -1) {
        ...
        $("#customer_eligibility_table").append('<tr><td>ID</td><td><div class="d-inline-block align-middle"><img src="'+img+'" class="img-radius img-40 align-top m-r-15"></td><td>'+name+'</td><td><button type="button" class="m-b-10 delete_applies_to_item delete_applies_to_item2 btn btn-danger"><i class="fa fa-trash-o"></i></button></td></tr>' );
    }
...
<script type="text/javascript">
    $('.discounts').on("click",'.delete_applies_to_item',function(){
        ...
        discount_apply_id=$(this).attr('id');


        $.ajax({
            type: 'post',
            url: baseURL+"/admin/discount/vk/deleteSpecificDiscountFor",
            data: {'discount_apply_id':discount_apply_id},
            success: function (result) {
                if(result.status=="true"){
                    notify(result.msg);
                    $('#'+discount_apply_id).remove();
    ...
    $('.discounts').on("click",'.delete_applies_to_item2',function(){
        $(this).parent().parent().remove();
    });
</script>
