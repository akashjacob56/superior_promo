...
<div class="pcoded-inner-content">
  <div class="main-body">
    <div class="page-wrapper">
      <div class="page-body">
        <div class="row">
          <form id="personal-info-form" class="w-100" method="post" action="{{$color->id}}" enctype='multipart/form-data'>
                ...
                <div class="card">
                  <div class="card-block">
                    ...
                    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                      ...
                      <input type="text" name="name" value="{{$color->name}}" class="form-control thresold-i" maxlength="40" placeholder="Enter Color name" >
                      @if ($errors->has('name'))
                    ...
                    <div class="form-group {{ $errors->has('color_hex') ? ' has-error' : '' }} ">
                      ...
                      <input type="text" name="color_hex" value="{{$color->color_hex}}" class="form-control thresold-i" maxlength="15" placeholder="Enter color hexadecimal  code/number">
