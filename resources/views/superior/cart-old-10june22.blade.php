    ...
    @if($data['products']!="[]")
		<main class="main">
                ...
                <div class="row d-flex align-items-center cart-box p-4 d-flex mb-1">
                      ...
                      <div class="col-md-3">
                      	...
                      	<div class="row">
							...
							<div class="col sub-p-details">#{{$product->product->brand_id}}</div>
							</div>
						    </p>
							</li>
              ...
              @endif
							...
							<div class="col sub-p-details">${{$product->price}}</div>
							</div>
							</p>
							</li>
				...
				@endforeach
                        ...
                        <div class="col-md-3" style="padding-top: 0px !important;padding-right: 0px !important;padding-left: 0px !important">
                      	...
                      	<h5 class="order-text" style="text-align: left;background-color: #F5F5F5;padding: 10px 0px;background: #F5F5F5;
													border: 1px solid #E1E1E1;
													box-sizing: border-box;
													box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);
													border-radius: 5px;padding-left: 7px;">Order Details</h5>
             ...
             <div style="padding:4px 10px;">
							...
							<div class="col order-price-text">${{$main_total}}</div>
							</div>
						    </p>
							</li>
							...
							<div class="col order-price-text ord-total">${{$main_total}}</div>
							</div>
							</p>
							</li>
