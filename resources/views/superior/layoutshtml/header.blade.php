                ...
                <div class="container">
                    <div class="header-left d-none d-sm-block">
                        <div class="info-box info-box-icon-left text-primary justify-content-start p-0">
                            ...
                            <div class="info-box-content">
                                <h4 class="text-transform-none"><b>General Information:</b> <span class="text-color-header"><a href="javascript:void(0);">info@superior.com</a></span></h4>
                            </div>
                            <!-- End .info-box-content -->
                            <div class="info-box-content art_info">
                                <h4 class="text-transform-none"><b>Art Information:</b> <span class="text-color-header"><a href="javascript:void(0);">art@superior.com</a></span></h4>
                            </div>
                        </div>
                    ...
                    <div class="header-right header-dropdowns ml-0 ml-sm-auto w-sm-100">
                       <!--  <div class="header-dropdown ">
                        ...
                        <!-- End .header-dropown -->
                        <!-- <i class="fas fa-bars"></i><pre> </pre> -->
                        <img class="img-fluid img_elite" src="{{asset('resources/views/superior/assetshtml/images/elite_seal.png')}}">
                        <div class="header-dropdown mr-auto mr-sm-3 mr-md-0">
                            ...
                            <div class="header-menu">
                               <b><span class="text_color_pink">Excellent!</span></b>
                            </div>
                        ...
                        <div class="header-dropdown dropdown-expanded d-none d-lg-block">
                            ...
                            <div class="header-menu">
                                <ul>
                                    ...
                                    <li><a href="login.html" class="login-link"><b>Log In</b></a></li>
                                    <li><a href="dashboard.html" class="login-link"><b>Register</b></a></li>
                                </ul>
                            </div>
                ...
                <div class="container">
                    <div class="header-left col-lg-2 w-auto pl-0">
                        ...
                        <a href="demo36.html" class="logo">
                            <img src="{{asset('resources/views/superior/assetshtml/images/superior-logo.png')}}" class="w-100" width="111" height="44" alt="Porto Logo">
                        </a>
                    </div>
                    <!-- End .header-left -->
                        ...
                        <a href="login.html" class="d-lg-block d-none">
                            <div class="header-user">
                                ...
                                <div class="header-userinfo">
                                    <span>Have as Question? We are here to help!</span>
                                    <h4 class="mb-0 text-color-header">1-800-234-5678</h4>
                                </div>
                            </div>
                        </a>
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo36-product.html" class="product-image">
                                                    <img src="assetshtml/images/demoes/demo36/products/product-1.jpg" alt="product" width="80" height="80">
                                                </a>
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo36-product.html" class="product-image">
                                                    <img src="assetshtml/images/demoes/demo36/products/product-2.jpg" alt="product" width="80" height="80">
                                                </a>
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="demo36-product.html" class="product-image">
                                                    <img src="assetshtml/images/demoes/demo36/products/product-3.jpg" alt="product" width="80" height="80">
                                                </a>
                                                <a href="#" class="btn-remove" title="Remove Product"><span>×</span></a>
                                            </figure>
                                        </div>
                ...
                <div class="container all_department_container">
                    <nav class="main-nav w-100">
                        <ul class="menu w-100">
                                    ...
                                    <ul class="menu menu-vertical sf-arrows d-block no-superfish">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5 p-0 d-lg-block d-none">
                                                        <div class="menu-banner menu-banner-2">
                                                            <figure>
                                                                <img src="assetshtml/images/demoes/demo40/menu-banner-1.jpg" alt="Menu banner" class="product-promo w-100">
                                                            </figure>
                                                            <i>OFF</i>
                                                    ...
                                                    <div class="col-lg-12 d-lg-block d-none">
                                                        <div class="partners-container row">
                                                            <div class="col-xl-5col">
                                                                <div class="partner">
                                                                    <img src="assetshtml/images/brands/small/brand1.png" alt="logo image" width="140" height="60"></div>
                                                            </div>
                                                            <div class="col-xl-5col">
                                                                <div class="partner">
                                                                    <img src="assetshtml/images/brands/small/brand2.png" alt="logo image" width="140" height="60"></div>
                                                            </div>
                                                            <div class="col-xl-5col">
                                                                <div class="partner">
                                                                    <img src="assetshtml/images/brands/small/brand3.png" alt="logo image" width="140" height="60"></div>
                                                            </div>
                                                            <div class="col-xl-5col">
                                                                <div class="partner">
                                                                    <img src="assetshtml/images/brands/small/brand4.png" alt="logo image" width="140" height="60"></div>
                                                            </div>
                                                            <div class="col-xl-5col">
                                                                <div class="partner">
                                                                    <img src="assetshtml/images/brands/small/brand5.png" alt="logo image" width="140" height="60"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="banner banner7 banner-md-vw text-transform-none">
                                                                    <figure>
                                                                        <img src="assetshtml/images/demoes/demo40/menu-banner-2.jpg" alt="banner">
                                                                    </figure>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="banner banner8 banner-md-vw">
                                                                    <figure>
                                                                        <img src="assetshtml/images/demoes/demo40/menu-banner-3.jpg" alt="banner">
                                                                    </figure>
                                        ...
                                        <li>
                                            ...
                                            <div class="megamenu megamenu-fixed-width megamenu-three">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <a href="#" class="nolink pl-0 d-flex flex-column align-items-start"><i class="icon-boy-broad-smile"></i>FOR HIM</a>
                                                    ...
                                                    <div class="col-lg-3 pl-xl-2">
                                                        <a href="#" class="nolink pl-0 d-flex flex-column align-items-start"><i class="icon-smiling-girl"></i>FOR HER</a>
                                                        <ul class="submenu pb-0">
                                                    ...
                                                    <div class="col-lg-3 pl-xl-0">
                                                        <a href="#" class="nolink pl-0 d-flex flex-column align-items-start"><i class="icon-smiling-baby"></i>FOR KIDS</a>
                                                        <ul class="submenu pb-0">
                                                    ...
                                                    <div class="col-lg-3 pl-xl-0">
                                                        <a href="#" class="nolink pl-0 d-flex flex-column align-items-start"><i class="icon-gift-2"></i>BIRTHDAY</a>
                                                        <ul class="submenu pb-0">
                                                    ...
                                                    <div class="col-lg-4 d-lg-block d-none">
                                                        <div class="product-widgets-container">
                                                            <div class="product-default left-details product-widget">
                                                                <figure>
                                                                    <a href="demo36-product.html">
                                                                        <img src="assetshtml/images/demoes/demo36/products/small/product-1.jpg" width="84" height="84" alt="product">
                                                                    </a>
                                                                </figure>
                                                            ...
                                                            <div class="product-default left-details product-widget">
                                                                <figure>
                                                                    <a href="demo36-product.html">
                                                                        <img src="assetshtml/images/demoes/demo36/products/small/product-2.jpg" width="84" height="84" alt="product">
                                                                    </a>
                                                                </figure>
                                                            ...
                                                            <div class="product-default left-details product-widget">
                                                                <figure>
                                                                    <a href="demo36-product.html">
                                                                        <img src="assetshtml/images/demoes/demo36/products/small/product-3.jpg" width="84" height="84" alt="product">
                                                                    </a>
                                                                </figure>
                                                            ...
                                                            <div class="product-default left-details product-widget">
                                                                <figure>
                                                                    <a href="demo36-product.html">
                                                                        <img src="assetshtml/images/demoes/demo36/products/small/product-4.jpg" width="84" height="84" alt="product">
                                                                    </a>
                                                                </figure>
                                                            ...
                                                            <div class="product-default left-details product-widget">
                                                                <figure>
                                                                    <a href="demo36-product.html">
                                                                        <img src="assetshtml/images/demoes/demo36/products/small/product-5.jpg" width="84" height="84" alt="product">
                                                                    </a>
                                                                </figure>
                                        ...
                                        <li>
                                            ...
                                            <div class="megamenu megamenu-fixed-width megamenu-five text-transform-none" style="background-image: url(assetshtml/images/demoes/demo40/menu-banner-4.jpg);">
                                                <div class="row">
                                                        ...
                                                        <div class="owl-carousel owl-theme show-nav-hover nav-outer dots-small" data-owl-options="{
                                                            ...
                                                            <div class="product-default">
                                                                <figure>
                                                                    <h5>FLASH DEALS</h5>
                                                                    <a href="demo36-product.html">
                                                                        <img src="assetshtml/images/demoes/demo36/products/product-1.jpg" width="450" height="450" alt="product">
                                                                    </a>
                                                                </figure>
                                                                <div class="product-details">
                                                                    <h3 class="product-title">
                                                            ...
                                                            <div class="product-default">
                                                                <figure>
                                                                    <a href="demo36-product.html">
                                                                        <img src="assetshtml/images/demoes/demo36/products/product-2.jpg" width="450" height="450" alt="product">
                                                                    </a>
                                                                </figure>
                                                                <div class="product-details">
                                                                    <h3 class="product-title">
                            ...
                            <li class="active">
                                <a href="demo36.html">Current promotions</a>
                            </li>
                            <!-- <li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 p-0">
                                            <div class="menu-banner">
                                                <figure>
                                                    <img src="assetshtml/images/menu-banner.jpg" width="192" height="313" alt="Menu banner">
                                                </figure>
                                                <div class="banner-content">
                                                    <h4>
                                ...
                                <div class="megamenu megamenu-fixed-width">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 p-0">
                                            <div class="menu-banner menu-banner-2">
                                                <figure>
                                                    <img src="assetshtml/images/menu-banner-1.jpg" alt="Menu banner" class="product-promo">
                                                </figure>
                                                <i>OFF</i>
                                                <div class="banner-content">
                                                    <h4>
                            ...
                            <li><a href="../../item/porto-ecommerce-shop-template/22685562.html" target="_blank">Full Art Services</a></li>
                            <li><a href="../../item/porto-ecommerce-shop-template/22685562.html" target="_blank">Under $1 Deals</a></li>
                            
                            <!-- <li class="float-right phone"><a href="#" class="d-flex align-items-center"><i class="icon-phone-1"></i>1-800-234-5678</a>
                            </li>
                            <li class="float-right"><a href="../../item/porto-ecommerce-shop-template/22685562.html" target="_blank">NEW
                                    ARRIVALS</a></li>
