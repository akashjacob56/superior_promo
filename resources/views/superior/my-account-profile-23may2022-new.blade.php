    ...
    color: #59BD8B !important;
						...
						<div class="tab-pane fade" id="order" role="tabpanel">
							...
							<div class="order-content">
								...
								<div class="row">
											<div class="col-lg-2">
												<p class="order-para"><span class="order_paragraph order_counts count_order_list">{{count($order_history)}} Order</span><span class="order-pargraph">&nbsp;Placed in</span></p>
											</div>
											<div class="col-lg-3">
															...
															<div class="row">
																		...
																		@if($orderitem!="")
																			...
																			@if($orderitem->product!="")
																				...
																				@if($orderitem->product->product_translation!="")
																					...
																					{{$order->orderitem->product->product_translation->product_name}}
																				@endif
																			@endif
									                					@endif
																	</p>
																...
																<div class="col-7">
																	...
																	<ul class="rorder-description-ul">
																		<li class="reorder_li">
																			1. Are the contents of this reorder going to be exactly the same?
																			...
																			<ul class="exaclty_no_ul" style="margin-left: 15px;">
																						<li class="exactly_no_li">
																							1.1 Is the quantity going to change?&nbsp;::
																			@if($order->orderitem!="")
																				@if($order->orderitem->reorder_show!="")
																			...
																			@endif
																						...
																						<li class="exactly_no_li">
																							1.2 Is item color going to change?&nbsp;::
																							@if($order->orderitem!="")
																								@if($order->orderitem->reorder_show!="")
																						...
																						<li class="exactly_no_li">
																							1.3 Is the imprint color going to change?&nbsp;::
																							@if($order->orderitem!="")
																								@if($order->orderitem->reorder_show!="")
																						...
																						<li class="exactly_no_li">
																							1.4 Are you going to be providing new artwork for this reorder?&nbsp;::
																							@if($order->orderitem!="")
																								@if($order->orderitem->reorder_show!="")
																		...
																		<li class="reorder_li">
																			2. When do you need this order delivered by?&nbsp;&nbsp;
																		...
																		<li class="reorder_li">
																			3. Is the shipping address for this order the same as before?&nbsp;&nbsp;
																			@if($order->orderitem!="")
																				@if($order->orderitem->reorder_show!="")
																		...
																		<li class="reorder_li">
																			4. Is the billing address for this order the same as before?&nbsp;&nbsp;
																			@if($order->orderitem!="")
																				@if($order->orderitem->reorder_show!="")
