    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-3">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <a href="/shop?page=&search=&cat_id=&category_id={{$data['product_categorydata']->category_id}}&color_id=&min=&max=&orderby=&pagi_num=&shop_cat_id=">{{$data['parent_category']->name}}</a></li>

                @if($data['child_category']!="")
                <li class="breadcrumb-item">
                <a href="/shop?page=&search=&cat_id=&category_id={{$data['product_categorydata']->category_id}}&color_id=&min=&max=&orderby=&pagi_num=&shop_cat_id=">{{$data['child_category']->name}}</a></li>
                @endif
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0);" class="currunt-dir">{{$data['product_categorydata']->product_translation->product_name}}</a></li>
                @endif
...
<i class="icon-plus"></i>
    ...
    <div class="col-lg-6 col-md-6 product-single-details">
        <h1 class=" product-name-txt">{{$data['productdetails']->product_name}}</h1>
            ...
            <div class="ratings-container">
                <span>Item Number :</span> <span class="item_id text-font-weight-500">#{{$data['product']->brand_id}}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<li>
    <div class="row pt-2 pb-2"> 
        ...
        <div class="col-md-3 cart-sub-item-modal subtotal-txt" id="subtotal-modal">$0</div>
    </div>
</li>
</ul> 
<hr class="short-divider short_divider with-imprints">
       ...
       @if($data['product_sub_images']!="")
        ...
        @endforeach
            ...
            <figure class="figure-content">
             ...
             <label> <input type="radio" name="address" c-name="{{$product_sub_image->color->name}}" value="{{$product_sub_image->color_id}}" class="color-id-selected main_color_{{$product_sub_image->color_id}}"> 
...
<label><input type="radio" name="address" c-name="{{$product_sub_image->color->name}}" value="{{$product_sub_image->color_id}}" class="color-id-selected main_color_{{$product_sub_image->color_id}}" id=""> <span style="background-color:{{$product_sub_image->color->color_hex}}; margin: 0px 2px 0px 2px!important;">
</span></label> 
</div>
</figure>
@endif
...
<div class="pricing-table-container pl-5">
   ...
   <div class="row">
    ...
    <?php $count++;?>
     <div class="quantity-container-price">
    @if($count==1)
...
<div class="col-md-4">
    ...
    <div class="type-quantity float-left">
        <label class="table-head-txt">Type Quantity</label><br>
         @if($data['old_cart_item_data']!="")
         <input type="number" id="user-quanity" value="{{$data['old_cart_item_data']->quantity}}" name="" class="type-quantity-input" placeholder="350">
         @else
         <input type="number" id="user-quanity" name="" class="type-quantity-input" placeholder="350">
         @endif
...
<div class="row pt-3">
      ...
      <div class="col-md-auto text-center">
        ...
        <label class="form-control-label price-txt  product_apparel-lbl"pa-id="{{$Apparel->id}}">{{$Apparel->apparel->apparel_name}}</label>
              <input type="number" name="apparel-qty[]"  class="form-control thresold-i apparelText app-qty old-apparel-qty{{$Apparel->apparel->id}}" placeholder="Qunatity">
          </div>        
    </div>
    @endforeach
</div>
...
<div class="row max-color-row">
    ...
    <div class="col-12" id="select-color-option-<?php echo $imprint->id;?>">
        ...
        <div class="col-md-12 pl-0">
            <select class="select-max-colors select-max-colors-1-{{$imprint->id}}   select-max-colors-{{$imprint->id}}" name="imp_color[]">
                <?php  $count=0;?>
...
<div class="tab-pane fade" id="recent-content1" role="tabpanel" aria-labelledby="recent-tab1">
    ...
    <div class="pt-3 pb-3">
        <span class="p-time">Production Time :</span> <span class="day-txt"><?php echo $data['product']->production_time_from ?> - <?php echo $data['product']->production_time_to ?> Working Days</span>
    </div>
 ...
 <div class="form-group form-check">
    ...
    <div class="row">
     <div class="col-md-6"> <label class="form-check-label p-time p-2 ml-5 " for="zip">Enter Zip Code to Get Shipping Cost</label></div>
...
$(document).ready(function(){
 ...
 /*$("#select-color-option-"+item.id).append('<div class=" select_imprint-'+item.id+'-'+select_count+'  col-md-12 pt-2 pb-2  cancel-color pl-0 cancel-color-row-'+item.id+'"><select class="select-max-colors select-max-colors-'+count+'-'+item.id+' select_imprint1-'+item.id+'-'+select_count+' select-max-colors-'+item.id+'" id="select_imprint1-'+item.id+'-'+select_count+'">@php $count=0;@endphp @if($data['imprints']!="[]")@foreach($data['imprints'] as $imprint1)@foreach($imprint1->imprint_colors as $imprint_color1)$count++; @if($count==1)<option selected="true" value="{{$imprint_color1->colors->id}}">{{$imprint_color1->colors->name}}</option>@else<option value="{{$imprint_color1->colors->id}}">{{$imprint_color1->colors->name}}</option>@endif @endforeach  @endforeach @endif</select> <button title="Close(Esc)"type="button"class="mfp-close">×</button></div>');   */
    ...
    $(".imprint-setprice-li-"+item.id).append('<div class="additional-color-peritem-li-'+item.id+'-'+select_count+' row pt-2 pb-2"><div class="col-md-9 cart-sub-item-modal">'+item.name+' Additional Color <span class="impt-color-'+item.id+'-'+select_count+'  impt-color-'+item.id+''+count+' ">('+item.imprint_colors[0].colors.name+')</span> fee(per item):</div><div class="col-md-3 cart-sub-item-modal peritempricecart-default peritempricecart-'+item.id+'" value="'+per_item_color_fee+'">$'+per_item_color_fee+'</div></div>');


    $(".imprint-setprice-li-"+item.id).append('<div class=" imprint-additional-color-li-'+item.id+'-'+select_count+' row pt-2 pb-2"><div class="col-md-9 cart-sub-item-modal">'+item.name+'Additional Color<span class="impt-color-'+item.id+'-'+select_count+' impt-color-'+item.id+''+count+' ">('+item.imprint_colors[0].colors.name+')</span> Setup fee:</div><div class="col-md-3 cart-sub-item-modal additionalpricecart-default additionalpricecart-'+item.id+'" value="'+additional_color_fee+'">$'+additional_color_fee+'</div></div>');

         
    $('.imprintallcolor-'+item.id).append('<span class="impt-color-'+item.id+'-'+select_count+' impt-color-'+item.id+''+count+' ">('+item.imprint_colors[0].colors.name+')</span>');
            ...
            var per_item_all=(parseInt(per_item_color_fee)*product_Quantity);
...
$.ajax({
    ...
    success:function(data){
        ...
        if(selected_imprint_price.length === 0){
          $("#per_item_price_modal").text('$'+ data.per_item_price);
          $("#subtotal-modal").text("$"+ data.subtotal);
...
// for selected color 
$(document).ready(function(){
    var selected_color=<?php echo $data['old_cart_item_data'];?>;
     var main_color=selected_color.cartitemcolor;
     if(main_color!==null){
     var color_id=main_color.color_id;
     $(".main_color_"+color_id).prop('checked', true);
   } 
...
$(document).ready(function(){
var Imprint=<?php echo $data['old_cart_item_data']->cartitemimprint;?>;

if(Imprint!=""&&Imprint!==null){

$.each(Imprint,function(index,item){

var imprint_id=item.imprint_id;

$('.imprint-main-check-'+item.imprint_id).trigger('click');

var count=(item.cart_item_imprint_color).length;

var color_count=0;

$.each(item.cart_item_imprint_color,function(index,item1){

color_count++;

$(".select-max-colors-"+color_count+"-"+imprint_id).val(item1.color_id);


if(color_count==1){
   $(".impt-color-"+imprint_id+'-'+'0').each(function(){
    $(this).text("("+item1.name+")");
 })
}


$(".impt-color-"+imprint_id+color_count).each(function(){
    $(this).text("("+item1.name+")");
})


if(color_count<count){      
$("#add-color-btn-"+imprint_id).trigger('click');
}
...
/*for step 2 data*/
$(document).ready(function(){
var data=<?php echo $data['old_cart_item_data'];?>;

if(data!=""&&data!==null){
$("#user-quanity").trigger('keyup');
 var received_date=data.received_date;
 if(received_date!==null&&received_date!=="ASAP"){
    $(".nodeadline").prop('checked',false);
    $(".deadline-date").prop('checked',true);
    $("#ship-delivery-date").val(received_date);
    $("#asap").text(received_date);
   }
 else{
    $(".nodeadline").prop('checked',true);  
  }


 var own_acc_number=data.own_account_number;
 var zipcode=data.estimation_zip; 
 var outside_us=data.outside_us; 
 var imprint_comment=data.imprint_comment;

 var own_account_number=data.own_account_number;
 var own_shipping_system=data.own_shipping_system;
 var own_shipping_type=data.own_shipping_type;

  if(own_acc_number!=null){
    $("#shipperac").trigger('change');
     $("#acnumber").val(own_account_number);
     $(".carrier").val(own_shipping_type);
     $(".method").val(own_shipping_system);
   }


  if(zipcode!=null){
    $(".zip-checkbox").trigger('change');
    $(".zipcode").val(zipcode);
   }
    

  if(outside_us!==0&&outside_us!=null){
    $("#outside").trigger('change');
   }
 

  if(imprint_comment!=null){
    $("#note-editable").val(imprint_comment);
   }
...
/*for selected product options*/

$(document).ready(function(){

var option_data=<?php echo $data['CartItemProductOptions'];?>;

if(option_data!=""&&option_data!==null){
$.each(option_data,function(index,item){


var option_id=item.product_option_id;
var value=item.cartitem_subproduct_options.product_sub_option_id;

$('.suboptionnotavailable'+option_id).val(value).change();
...
/*for apparel old data */
$(document).ready(function(){
var apparel_data=<?php echo $data['CartItemSizeGroups'];?>;

if(apparel_data!=""&&apparel_data!==null){
$.each(apparel_data,function(index,item){
     $('.old-apparel-qty'+item.cartitemsize.size_id).val(item.cartitemsize.qty);
});  
