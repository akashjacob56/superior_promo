  ...
  .vshopy-product-image:hover .hovr-img{
    ...
    .vshopy-product-image:hover .hovr-img {
      ...
      .title{
        ...
        background-image: -webkit-linear-gradient(transparent, transparent),url({{$base_url}}/files/assets/images/3.gif) !important; 
      }
...
color: #575757;
    ...
    <style type="text/css">
      ...
      background-image: linear-gradient(to left,rgba(0,0,0,0.08) 89%,  rgb(124, 196, 236) 89%); background-size: 100% 1px;
      background-repeat: no-repeat;
...
<a href="{{$base_url}}/shop?page=1&search=&cat_id=&category_id=&color_id=&min=&max=100&orderby=&pagi_num=1&shop_cat_id=&max_quantity=16&min_quantity=&under_dollar_1=">

 <div class="">
  <img class="home-slider-image" src="{{$base_url}}/storage/app/{{$slider->default_slider_translation->slider_image}}" alt="slider image">
...
<section class="home-products-intro mt-3 mb-5">
  ...
  @endphp
      ...
      <div class="col-xl-4">
        <a href="{{$base_url}}/shop?page=1&search=&cat_id=&category_id=&color_id=&min=&max=100&orderby=&pagi_num=1&shop_cat_id=&max_quantity=16&min_quantity=&under_dollar_1=">
        <div class="banner-product banner-product-top banner-offer" style="background-image: url('{{$base_url}}/storage/app/{{$offer_block->offer_block_image}}');background-position : 36%;">
...
<section class="new-products-section mb-5">
  <div class="container">
  <button class=" btn-view-all-1" style="float: right;margin-top: 18px;"><a href="{{$base_url}}/shop?page=1&search=&cat_id=&category_id=&color_id=&min=&max=100&orderby=newness&pagi_num=1&shop_cat_id=&max_quantity=16&min_quantity=&under_dollar_1=">View All</a></button>
...
<!--   <li class="nav-item" role="presentation">
    <button class="nav-link active" id="latest_products_tab" data-bs-toggle="tab" data-bs-target="#latest_product_tab_panel" type="button" role="tab" aria-controls="latest_product_tab_panel" aria-selected="true">Latest Products</button>
  </li>
   <li class="line-b-li"></li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Best Selling</button>
  </li>
  <li class="line-b-li"></li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="under_dollar_1_tab" data-bs-toggle="tab" data-bs-target="#under_dollar_1_tab_panel" type="button" role="tab" aria-controls="under_dollar_1_tab_panel" aria-selected="false">Under $1 Deals</button>
  </li> -->
              <li class="nav-item">
                <a class="nav-link font-nav-tab active" id="latest-product-tab" data-toggle="tab" href="#latest_product_tab_panel" role="tab" aria-controls="latest_product_tab_panel" aria-selected="false">
                    Latest Products
                </a>
              </li>
              &nbsp;
              ...
              <li class="nav-item">
                <a class="nav-link font-nav-tab " id="best-selling-products" data-toggle="tab" href="#best_selling_products_tab_panel" role="tab" aria-controls="best_selling_products_tab_panel" aria-selected="false">
                    Best Selling
                </a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link font-nav-tab " id="under_dollar_1-tab" data-toggle="tab" href="#under_dollar_1_tab_panel" role="tab" aria-controls="under_dollar_1_tab_panel" aria-selected="false">
                    under $1 Deals
                </a>
              </li>
...
<!-- <div class="tab-content" id="myTabContent_latest_product"> -->
  <!-- <div class="tab-pane fade show active" id="latest_product_tab_panel" role="tabpanel" aria-labelledby="latest_products_tab"> -->
    <div class="tab-pane fade show active" id="latest_product_tab_panel" role="tabpanel">
...
<div class="product-default">
      ...
      <div class="wishlist_content wishlist_content_{{$product->product_id}}" style="z-index: 1;position: absolute;margin-left: 80%;margin-top:0px;cursor:pointer;" product_id="{{$product->product_id}}">
          <!-- <img src="{{$base_url}}/resources/views/superior/assets/images/my-heart.png"> -->
  ...
  <p class="d-msg-txt">{{$product->default_product_translation->delivery_message}}</p>
    ...
    .as_low_as_spna_text {
      ...
      @if($min_per_item_price!="") 
            <p style="color: #575757;"><span class="as_low_as_spna_text">As Low As </span><span class="color-67a03c">${{$min_per_item_price}}</span> </p>
      @elseif($min_per_item_sale_price!="")
            <p>As Low As <span class="color-67a03c ">${{$min_per_item_sale_price}}</span> </p>
      @elseif($min_setup_price!="")
            <p>As Low As <span class="color-67a03c ">${{$min_setup_price}}</span> </p>
      @else
      <p>
        <br>
      </p>
...
<div class="product-action">
  ...
  <button class="btn-icon btn-add-cart"><a href="{{$base_url}}/product/{{$product->product_url}}?pid={{$product_translation->product_id}}"class="product-cart-hover" ><i class="fa fa-shopping-cart" aria-hidden="true" style="color: #575757;"></i>&nbsp;&nbsp;&nbsp;Add to cart&nbsp;&nbsp;&nbsp;</a></button>
...
<!-- =================================================== Best Selling Product Start ======================================================= -->
      ...
      <div class="tab-pane fade displayNone" id="best_selling_products_tab_panel" role="tabpanel">
                  <div class="products-slider custom-products owl-carousel owl-theme nav-outer show-nav-hover nav-image-center" data-owl-options="{
    'dots': false,
    'nav': true,
    'responsive': {
...
<section class="home-products-intro mt-3 mb-1">
  ...
  @endphp
      ...
      <div class="col-xl-6">
        <a href="{{$base_url}}/shop?page=1&search=&cat_id=&category_id=&color_id=&min=&max=100&orderby=&pagi_num=1&shop_cat_id=&max_quantity=16&min_quantity=&under_dollar_1=" >
        <div class="banner-product banner-offer banner-product-middle" style="background-image: url('{{$base_url}}/storage/app/{{$offer_block->offer_block_image}}');background-position : 54%;">
...
<section class="container mb-5">
  ...
  <div class="section-title mb-2">
    <h2 style="margin-bottom: 5px;" class="top-txt">@lang("product.top_categories") </h2>
  </div>
...
<div class="product-category">
    ...
    <!-- <figure> -->
       ...
       <div class="wishlist_content wishlist_category_content_{{$product_is_stock_collection->product_id}}" style="z-index: 1;position: absolute;margin-left: 90%;margin-top: 10px;cursor:pointer;" product_id="{{$product_is_stock_collection->product_id}}">
      ...
      <!-- <i class="fa fa-heart-o " style="color: #000000;font-size:20px;"></i>  -->
       ...
       @if($user_wishlists!="[]" && in_array($product->product_id,$user_wishlists))
        ...
        <img src="{{$base_url}}/storage/app/{{$product_is_stock_collection->product_image}}" class="product_image_collection product_collection">
    ...
    <div class="category-content">
      ...
      <p class="text-capitalize"><span style="font-size: 14px;line-height: 16px;" class="text-capitalize text-dark">Item</span> - <span class="" style="color: black !important;font-weight: 500;font-size: 14px;line-height: 16px;"><b>#{{$product_is_stock_collection->product_id}}</b></span></p>
      ...
      @if($min_per_item_price!="")
      <p class="as_low_as_spna_text">As Low As <span class="color-67a03c ">${{$min_per_item_price}}</span> </p>
      @elseif($min_per_item_sale_price!="")
        <p class=".as_low_as_spna_text">As Low As <span class="color-67a03c ">${{$min_per_item_sale_price}}</span> </p>
      @elseif($min_setup_price!="")
        <p class=".as_low_as_spna_text">As Low As <span class="color-67a03c ">${{$min_setup_price}}</span> </p>
      @else
  ...
  <button class="btn-icon btn-add-cart btn-add-cart-css"><a href="{{$base_url}}/product/{{$product_is_stock_collection->product_url}}?pid={{$default_product_translation_full->product_id}}" class="product-cart-hover" style="color: #777;" ><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Add to cart&nbsp;&nbsp;&nbsp;</a></button>
...
<div class="col-xl-12">
  ...
  @endphp
        ...
        <a href="{{$base_url}}/shop?page=1&search=&cat_id=&category_id=&color_id=&min=&max=100&orderby=&pagi_num=1&shop_cat_id=&max_quantity=16&min_quantity=&under_dollar_1=" >
        <div class="banner-product banner-offer banner-product-side" style="background-image: url('{{$base_url}}/storage/app/{{$offer_block->offer_block_image}}');background-position : 54%;">
...
@endforeach
  ...
  @endphp
        ...
        <a href="{{$base_url}}/shop?page=1&search=&cat_id=&category_id=&color_id=&min=&max=100&orderby=&pagi_num=1&shop_cat_id=&max_quantity=16&min_quantity=&under_dollar_1=" >
        <div class="banner-product banner-offer-two banner-offer" style="background-image: url('{{$base_url}}/storage/app/{{$offer_block->offer_block_image}}');">
...
<section class="home-products-intro mt-1 mb-6">
 <div class="container top-border d-flex align-items-center justify-content-between flex-wrap" style="background-color: #384faa !important;padding:4rem 5rem;">
      <div class="footer-left widget-newsletter d-md-flex align-items-center">
        <div class="widget-newsletter-info">
          <h5 class="widget-newsletter-title text-capitalize m-b-1" style="font-size: 27px;">Sign Up for Great Offers!</h5>
 ...
 <div class="footer-right">
     ...
     <form method="post" action="{{$base_url}}/subscription-email" style="margin-top: 1rem;margin-bottom: 1rem !important;">
         <input type="hidden" name="_token" value="{{csrf_token()}}">
         <div class="footer-submit-wrapper d-flex">
          <input type="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="news_letter_email" placeholder="Enter e-mail here" size="40" required="">
          <button type="submit" class="btn btn-primary btn-sm" style="height:45.5px;">@lang("navigation.subscribe")</button>
        </div>
      </form>
    </div>
...
<section class="home-products-intro mt-3">
  ...
  @endphp
      ...
      <div class="col-xl-12" style="padding-left: 0px !important;padding-right: 0px !important;">
        <a href="{{$base_url}}/shop?page=1&search=&cat_id=&category_id=&color_id=&min=&max=100&orderby=&pagi_num=1&shop_cat_id=&max_quantity=16&min_quantity=&under_dollar_1=" >
        <div class="banner-product banner-product-bottom banner-offer" style="background-image: url('{{$base_url}}/storage/app/{{$offer_block->offer_block_image}}');background-position : 54%;">
...
<section class="container mb-6">
  ...
  <div class="section-title mb-2 section_title_happy_customer" style="">
   ...
   <div class="brands-section mt-2 mb-3 appear-animate" data-animation-delay="200" data-animation-name="fadeIn" data-animation-duration="1000" style="margin-left: 2.1%;margin-right: 2.1%;">
                       <!--  <div class="headding">
                        ...
                        <div class="brands-slider owl-carousel bg-white owl-theme nav-circle images-center" data-owl-options="{
                            ...
                            <figure class="figure-content">
                              ...
                              <img style="" src="{{$base_url}}/resources/views/superior/assets/images/brands//small/brand1.png" class="happy" alt="brand">

                            </figure>
                            <figure><img src="{{$base_url}}/resources/views/superior/assets/images/brands//small/brand2.png" class="happy" alt="brand">
                            </figure>
                            <figure><img src="{{$base_url}}/resources/views/superior/assets/images/brands//small/brand3.png" class="happy" alt="brand">
                            </figure>
                            <figure><img src="{{$base_url}}/resources/views/superior/assets/images/brands//small/brand4.png" class="happy" alt="brand">
                            </figure>
                            <figure><img src="{{$base_url}}/resources/views/superior/assets/images/brands//small/brand5.png" class="happy" alt="brand">
                            </figure>
                            <figure><img src="{{$base_url}}/resources/views/superior/assets/images/brands//small/brand6.png" class="happy" alt="brand">
                            </figure>
                            <figure><img src="{{$base_url}}/resources/views/superior/assets/images/brands//small/brand4.png"  class="happy" alt="brand">
                            </figure>
                        </div>
...
<article class="post">
  <div class="post-media">
    <a href="{{$base_url}}/blog/{{$blog->url}}">
      <img src="{{$base_url}}/storage/app/{{$blog->image}}" alt="Post" width="225" height="280">
    </a>
    <div class="post-date">
