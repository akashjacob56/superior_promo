...
<div class="pcoded-inner-content">
  <div class="main-body">
    <div class="page-wrapper">
      <div class="page-body">
        <div class="row">
          <form id="personal-info-form" method="post" action="{{$return_policy->return_policy_id}}" enctype='multipart/form-data'>
            ...
            <div class="card">
              <div class="card-block">
                ...
                <div class="form-group {{ $errors->has('return_policy_title') ? ' has-error' : '' }}">
                  ...
                  <input type="text" name="return_policy_title" value="{{$return_policy->default_return_policy_translation->return_policy_title}}" class="form-control thresold-i" maxlength="40" placeholder="Enter Return Policy title" >
                ...
                <div class="form-group form-primary {{ $errors->has('is_bd') ? ' has-error' : '' }} col-md-6 pt-3">
                  <tr>
                    <td>  
                      <div class="checkbox-fade fade-in-primary">
                        <label>
                          <input type="checkbox" id="is_available_for_return" name="is_available_for_return" value="1">
                ...
                <div class="form-group form-primary {{ $errors->has('is_bd') ? ' has-error' : '' }} col-md-6 pt-3">
                  <tr>
                    <td>  
                      <div class="checkbox-fade fade-in-primary">
                        <label>
                          <input type="checkbox" id="is_available_for_return_replace" name="is_available_for_return_replace" value="1">
                          <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                ...
                <div class="form-group {{ $errors->has('return_days') ? ' has-error' : '' }}">
                  ...
                  <input id="return_days" type="number" name="return_days" value="{{old('return_days',$return_policy->return_days)}}"  class="form-control thresold-i"  placeholder="Return Days" >
                ...
                <div class="form-group {{ $errors->has('return_policy_description') ? ' has-error' : '' }}">
                  ...
                  @if ($errors->has('return_policy_description'))
                  <span class="help-block">
...
['fontNamesIgnoreCheck', [ 'Serif', 'Sans', 'Arial', 'Arial Black', 'Courier', 'Courier New', 'Comic Sans MS', 'Helvetica', 'Impact', 'Lucida Grande', 'Sacramento']],
  ...
  if ({{$return_policy->is_available_for_return}}==1) {
    $('#is_available_for_return').prop('checked',true);
  }
  if ({{$return_policy->is_available_for_return_replace}}==1) {
    $('#is_available_for_return_replace').prop('checked',true);
  }
</script>
@endsection