...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="col-md-6">
         <form action="{{$base_url}}/searchProducts" id="search-form" method="post" class="nav-link search-navlink" style="float: right;width: 100%;">
 ...
 <div class="col-md-12">
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active"><a href="{{$base_url}}/about" class="nav-link">About Us</a></li> 
     ...
     @endphp
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                @endphp
              	<a class="dropdown-item" href="{{$base_url}}/collection/{{$child_category_translation->category->category_url}}">{{$child_category_translation->category_name}}</a>
                @endif
...
@endforeach
             ...
             <!--  <li class="nav-item active"><a href="{{$base_url}}/collection/{{$category->category_url}}" class="nav-link">{{$category_translation->category_name}}</a></li>  -->
            @endif
            @endforeach
            @endif
	          ...
	          <li class="nav-item cta cta-colored"><a href="{{$base_url}}/cart" class="nav-link"><span class="icon-shopping_cart cart-count"></span>[<span id="cart_count"></span>]</a></li>
			  <li class="nav-item cta cta-colored"><a href="{{$base_url}}/wishlist" class="nav-link"><span class="icon-heart"></span></a></li>
                  @if(Auth::user())
          <li class="nav-item dropdown">
             ...
             <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                @if($role_id!=3)
                  ...
                  <a class="dropdown-item" href="{{$base_url}}/admin/home">
          ...
          @else
			  <li class="nav-item cta cta-colored"><a href="{{$base_url}}/login" class="nav-link"><span class="icon-user" style="margin-right: 3px;"></span>Login/Register</a></li>
        @endif
