...
<div class="pcoded-inner-content">
  <div class="main-body">
    <div class="page-wrapper">
      <div class="page-body">
        <div class="row">
          <form id="personal-info-form" method="post" action="{{$apparel->id}}" enctype='multipart/form-data'>
            ...
            <div class="card">
              <div class="card-block">
                ...
                <div class="form-group {{ $errors->has('apparel_name') ? ' has-error' : '' }}">
                  ...
                  <input type="text" name="apparel_name" value="{{$apparel->apparel_name}}" class="form-control thresold-i" maxlength="10" placeholder="Enter Size Name">
