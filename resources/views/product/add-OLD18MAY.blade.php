                ...
                <div class="card">
                  <div class="card-block">
                    ...
                    <div class="col-md-6 {{ $errors->has('item_color_group_id') ? ' has-error' : '' }} ">
                        ...
                        <select name="item_color_group_id" class="form-control">
                          <option selected="" disabled="">Select color group</option>
                            @foreach($color_groups as $color_group)
                            <option value="{{$color_group->id}}">{{$color_group->name}}</option>
                            @endforeach
                  ...
                  <div class="card-block">
                    <div class="form-group {{ $errors->has('product_image') ? ' has-error' : '' }}">
                      ...
                      <label for="file" class="custom-file">
                        <input type="file" name="product_image" class="form-control " accept="image/x-png,image/gif,image/jpeg" value="{{old('product_image')}}" onchange="document.getElementById('product_image').src = window.URL.createObjectURL(this.files[0])"/>
