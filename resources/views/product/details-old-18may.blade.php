	...
	<div class="main-body">
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header no-border">
									<h5>{{$product->default_product_translation->product_name}}</h5>
      ...
      <div class="form-group {{ $errors->has('additional_information') ? ' has-error' : '' }}">
                  ...
                  <div class="card-block price_product_grid_div" id="price_product_grid_div">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('count_from') ? ' has-error' : '' }}">
                                  <label class="form-control-label">Count<br>from</label>
                              </div>        
                        </div>
                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('setup_price') ? ' has-error' : '' }}">
                                  <label class="form-control-label">Setup<br>Price</label>
                              </div>    
                        </div>
                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('per_item_price') ? ' has-error' : '' }}">
                                  <label class="form-control-label">Per Item Price</label>
                              </div>        
                        </div>
                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('per_item_sale_price') ? ' has-error' : '' }}">
                                  <label class="form-control-label">Per Item Sale Price</label>
                             </div>        
                        </div>
                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('custom_cost') ? ' has-error' : '' }}">
                                  <label class="form-control-label"><br>Actions</label>
                              </div>        
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('count_from') ? ' has-error' : '' }}">
                                  <input id="count_from" type="number" name=""  class="form-control thresold-i" placeholder="Count From" value="{{$product_price->count_from}}" disabled="">
                              </div>        
                        </div>

                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('setup_price') ? ' has-error' : '' }}">
                                    <input id="setup_price" type="text" name=""  class="form-control thresold-i" placeholder="Setup Price" value="{{$product_price->setup_price}}" disabled="">
                              </div>    
                        </div>  

                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('per_item_price') ? ' has-error' : '' }}">
                                    <input id="per_item_price" type="text" name="" class="form-control thresold-i" placeholder="Per Item Price" value="{{$product_price->per_item_price}}" disabled="">
                              </div>        
                        </div>

                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('per_item_sale_price') ? ' has-error' : '' }}">
                                    <input id="per_item_sale_price" type="text" name=""  class="form-control thresold-i" placeholder="Per Item Sale Price" value="{{$product_price->per_item_sale_price}}" disabled="">
                              </div>        
                        </div>
                        ...
                        <div class="col-md-2">
                              <div class="form-group {{ $errors->has('custom_cost') ? ' has-error' : '' }}">
                                  ...
                                  <a href="{{$base_url}}/productPriceDelete?product_price_id={{$product_price->product_price_id}}">
                                    <button id="" type="button" class="form-control thresold-i"><i class="fa fa-trash"></i></button>
                                  </a>
                    ...
                    <div class="row">
                    	<div class="col-md-12 text-right">
                    		...
                    		<button type="button" class="btn btn-link pull-right cancel-product-price">Cancel</button>
                    	</div>
                    </div>
...
<input type="hidden" id="market_price" name="market_price" value="{{old('market_price')}}"  class="form-control thresold-i" value="1" placeholder="Rs. 120.00" maxlength="10">
                ...
                <div class="card">
                  <div class="card-block">
                    ...
                    <div class="form-group row">
                    <div class="col-md-12 {{ $errors->has('sage_id') ? ' has-error' : '' }} ">
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                          <div class="row">
                              <div class="col-md-2">
                                  <!--<label class="form-control-label">Count <br>From<br><br><br></label>-->
                                  <input type="number" id="imprint_count_from{{$imprint_price->id}}" name=""  class="form-control thresold-i" placeholder="Count From" maxlength="10" value="{{$imprint_price->quantity}}" >
                              </div>

                              <div class="col-md-2">
                                  <!--<label class="form-control-label">Location Setup <br>Fee<br><br></label>-->
                                  <input type="text" id="imprint_location_setup_fee{{$imprint_price->id}}" name=""  class="form-control thresold-i" placeholder="Location Setup" maxlength="10" value="{{$imprint_price->setup_price}}" >
                              </div>

                              <div class="col-md-2">
                                  <!--<label class="form-control-label">Additional Location Running Fee</label>-->
                                  <input type="text" id="imprint_additinal_location_running_fee{{$imprint_price->id}}" name=""   class="form-control thresold-i" placeholder="Additional Location" maxlength="10" value="{{$imprint_price->item_price}}" >
                              </div>

                              <div class="col-md-2">
                                  <!--<label class="form-control-label">Additional Color<br> Setup<br> Fee</label>-->
                                  <input type="text" id="imprint_additional_setup_fee{{$imprint_price->id}}" name=""   class="form-control thresold-i" placeholder="addn setup fee" maxlength="10" value="{{$imprint_price->color_setup_price}}" >                                  
                              </div>

                              <div class="col-md-2">
                                  <!--<label class="form-control-label">Additional Color Running Fee</label>-->
                                  <input type="text" id="imprint_additional_running_fee{{$imprint_price->id}}" name=""  class="form-control thresold-i" placeholder="addn runn fee" maxlength="10" value="{{$imprint_price->color_item_price}}" >
                              </div>
                              ...
                              <div class="col-md-2 {{ $errors->has('count_from') ? ' has-error' : '' }}">
                                  ...
                                  <a href="{{$base_url}}/admin/product/imprintProductPriceDelete/{{$imprint_price->id}}">
                                    ...
                                    <button style="cursor: pointer;" class=" btn btn-info form-control imprint_price_edit{{$imprint_price->id}}" type="button">Save</button>
                ...
                <div class="card">
                  <div class="card-block">
                    ...
                    <div class="col-md-6 {{ $errors->has('item_color_group_id') ? ' has-error' : '' }} ">
                        <label class="form-control-label">Import Color From Color Group</label>
                       

                        <select name="item_color_group_id" class="form-control item_color_group_id">
                          <option selected="" disabled="">Select color group id</option>
                            @foreach($color_groups as $color_group)
                            <option value="{{$color_group->id}}">{{$color_group->name}}</option>
                            @endforeach
                        </select>
