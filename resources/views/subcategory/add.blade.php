           ...
           <div class="col-sm-12">
            <div class="card">
              <div class="card-header no-border">
                ...
                <span>Sub Category are the primary way to combine products with similar characteristic. You can also add sub-categories if required.</span>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              <div class="card-block">
                ...
                <div class="form-group {{ $errors->has('category_name') ? ' has-error' : '' }}">
                  ...
                  <input id="category_name" type="text" name="category_name" value="{{old('category_name')}}"  class="form-control thresold-i" maxlength="25" placeholder="Sub Category Name" >
                ...
                <div class="form-group {{ $errors->has('category_url') ? ' has-error' : '' }}">
                  ...
                  <input id="category_url" type="text" name="category_url" value="{{old('category_url')}}"  class="form-control thresold-i" placeholder="Sub Category Url" >
                ...
                <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                  ...
                  <textarea name="description" class="form-control summernote-editor" rows="" placeholder="Enter Sub Category description">{{old('description')}}</textarea>
