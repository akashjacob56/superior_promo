$.fn.pcodedmenu = function(settings) {
    settings.FixedNavbarPosition=true;
    settings.FixedHeaderPosition=true;
    settings.verticalMenuplacement=allignment;
    settings.verticalMenulayout="box";
    var oid = this.attr("id");
    // Pcoded Menu default settings:
    var defaults = {
        // Common option both for vertical nad horizontal
        themelayout: 'horizontal', // value should be horizontal/vertical
