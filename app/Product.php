...
class Product extends Model{
	...
	public static $rules=[
		...
		'product_image'=>'required|image|max:5024',

/*		'count_from[]'=>'required|numeric|min:0|max:9999999',
		'setup_price[]'=>'required|numeric|min:0|max:9999999',
		'per_item_price[]'=>'required|numeric|min:0|max:9999999',
		'per_item_sale_price[]'=>'required|numeric|min:0|max:9999999',*/


/*		'option_count_from'=>'numeric|min:0|max:9999999',
		'option_setup_fee'=>'numeric|min:0|max:9999999',
		'option_additional_fee'=>'numeric|min:0|max:9999999',*/


/*		'imprint_count_from'=>'numeric|min:0|max:9999999',
		'imprint_location_setup_fee'=>'numeric|min:0|max:9999999',
		'imprint_additinal_location_running_fee'=>'numeric|min:0|max:9999999',
		'imprint_additional_setup_fee'=>'numeric|min:0|max:9999999',
		'imprint_additional_running_fee'=>'numeric|min:0|max:9999999',*/
   ...
   public function product_review(){
		return $this->belongsTo('App\ProductReview','product_id','product_id');
	}
