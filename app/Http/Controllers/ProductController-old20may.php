...
if($item_color_group_id!=""&&$item_color_group_name!=""){
		...
		$product_color_group = ProductColorGroup::where('product_id',$product_id)->where('name',$item_color_group_name)->first();
